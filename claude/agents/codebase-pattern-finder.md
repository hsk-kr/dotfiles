...
description: Finds similar implementations, usage examples, or existing patterns that can be modeled after. Gives you concrete code examples based on what you're looking for.
